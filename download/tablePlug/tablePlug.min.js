...
layui.define(["table"], function(e) {
	...
	function a(e, t, i) {
		...
		var l = {};
		if (i && t.top !== t.self) {
			var n = t.frames.frameElement;
			l = a(n, t.parent, i)
		}
		var o = e.getBoundingClientRect();
		return {
			top: o.top + (l.top || 0),
			left: o.left + (l.left || 0)
		}
	}
	var t = "2.0.0-preview1",
		i = "tablePlug",
		l = layui.cache.modules[i] || "",
		n = l.substr(0, l.lastIndexOf("/"));
	...
	if (!d.render.plugFlag) {
		...
		d.render = function(e, a, t) {
			...
			return t ? layui.each(t, function(a, t) {
				t = o(t);
				var n = t.parent(),
					r = n.hasClass("layui-form"),
					c = n.attr("lay-filter");
				r ? "" : n.addClass("layui-form"), c ? "" : n.attr("lay-filter", "tablePlug_form_filter_temp_" + (new Date).getTime() +
					"_" + Math.floor(1e5 * Math.random())), i = y.call(l, e, n.attr("lay-filter")), r ? "" : n.removeClass(
					"layui-form"), c ? "" : n.attr("lay-filter", null)
			}) : i = y.call(l, e, a), i
		}, d.render.plugFlag = !0
	}
	layui.extend({
		optimizeSelectOption: "{/}" + n + "/optimizeSelectOption/optimizeSelectOption"
	...
	var h, p = "2.5.4",
		...
		F = function() {
			...
			return {
				...
				update: function(a, t, i, l) {
					var n = e[a][x],
						o = e[a][v],
						r = e[a][b];
					i ? (l && o.splice(0, 1), n.indexOf(t) === -1 ? o.indexOf(t) === -1 && o.push(t) : l || r.indexOf(t) === -1 ||
						r.splice(r.indexOf(t), 1)) : n.indexOf(t) === -1 ? o.indexOf(t) !== -1 && o.splice(o.indexOf(t), 1) : r.indexOf(
						t) === -1 && r.push(t)
				}
			}
		}(),
		...
		M = function(e, a, t) {
			if (e && a && (t = t || Z(a), t && t.checkStatus))
				for (var i = F.getChecked(a), l = 0; l < e.length; l++) e[l][u.config.checkName] = i.indexOf(e[l][te(t)]) !== -1
		},
		H = function(e, a) {
			var t;
			if ("string" == typeof e ? t = Z(e) : (t = e.config, e = t ? t.id : ""), t) {
				...
				a && (t.checkDisabled = t.checkDisabled || {}, t.checkDisabled.enabled = t.checkDisabled.enabled || !0, t.checkDisabled
						.data = F.get(e, k) || []), t.checkDisabled && t.checkDisabled.enabled ? layui.each(u.cache[e], function(a, l) {
						i.find(".layui-table-body").find('tr[data-index="' + a + '"]').find(
							'input[name="layTableCheckbox"],[lay-type="layTableRadio"]').prop("disabled", F.checkDisabled(e, l[te(t)]))
	...
	u.Class.prototype.errorView = function(e) {
		...
		if (t.startTime = (new Date).getTime(), i.url) {
			...
			"function" == typeof i.renderRequest && (s = i.renderRequest(s)), i.contentType && 0 == i.contentType.indexOf(
				...
				headers: i.headers || {},
				success: function(l) {
					"function" == typeof i.parseData && (l = i.parseData(l) || l), l[n.statusName] != n.statusCode ? (t.renderForm(),
						t.errorView(l[n.msgName] || '返回的数据不符合规范，正确的成功状态码应为："' + n.statusName + '": ' + n.statusCode)) : (t.renderData(
							l, e, l[n.countName], !1, a && (!i.page || i.page.count === l[n.countName])), r(), i.time = (new Date).getTime() -
						t.startTime + " ms"), a ? t.loading(!0) : t.setColsWidth(), "function" == typeof i.done && i.done(l, e, l[
						n.countName])
				},
				error: function(e, i) {
			...
			var d = {},
				u = e * i.limit - i.limit;
			d[n.dataName] = i.data.concat().splice(u, i.limit), d[n.countName] = i.data.length, t.renderData(d, e, d[n.countName],
					!1, a && (!i.page || i.page.count === i.data.length)), r(), a ? t.loading(!0) : t.setColsWidth(), "function" ==
				typeof i.done && i.done(d, e, d[n.countName])
		}
		...
		var n = this,
			...
			g = function() {
				var e;
				return !i && n.sortKey ? n.sort(n.sortKey.field, n.sortKey.sort, !0) : (layui.each(f, function(t, l) {
						var c = [],
							s = [],
							f = [],
							g = t + d.limit * (a - 1) + 1;
						0 !== l.length && (i || (l[u.config.indexName] = t), n.eachCols(function(a, i) {
							...
							if (void 0 !== h && null !== h || (h = ""), !i.colGroup) {
								var p = ['<td data-field="' + n + '" data-key="' + y + '" ' + function() {
									var e = [];
									return i.edit && e.push('data-edit="' + i.edit + '"'), i.align && e.push('align="' + i.align + '"'),
										i.templet && e.push('data-content="' + h + '"'), i.toolbar && e.push('data-off="true"'), i.event &&
										e.push('lay-event="' + i.event + '"'), i.style && e.push('style="' + i.style + '"'), i.minWidth &&
										e.push('data-minwidth="' + i.minWidth + '"'), e.join(" ")
								}() + ' class="' + function() {
									var e = [];
									...
									switch (i.type) {
										...
										case "radio":
											return a[n] && (e = t), '<input type="radio" name="layTableRadio_' + d.index + '" ' + (a[n] ?
					...
					}), l || n.layBody.scrollTop(0), n.layMain.find("." + D).remove(), n.layMain.find("tbody").html(y.join("")), n
					.layFixLeft.find("tbody").html(h.join("")), n.layFixRight.find("tbody").html(p.join("")), n.renderForm(),
					"number" == typeof e && n.setThisRowChecked(e), n.syncCheckAll(), n.haveInit ? n.scrollPatch() : setTimeout(
						function() {
							n.scrollPatch()
						}, 50), n.haveInit = !0, s.close(n.tipsIndex), d.HAS_SET_COLS_PATCH || n.setColsPatch(), void(d.HAS_SET_COLS_PATCH = !
						0))
			};
		M(f, d.id, d);
		var m = u.getTemp(n.key);
		return n.tempData = m.data, u.cache[n.key] = f, n.layPage[0 == t || 0 === f.length && 1 == a ? "addClass" :
			"removeClass"](P), 0 === f.length ? (n.renderForm(), n.errorView(d.text.none), W.call(n, !0)) : (n.layFixed.removeClass(
			P), i ? (g(), W.call(n)) : (g(), l ? W.call(n) : (n.renderTotal(f), n.layTotal && n.layTotal.removeClass(P), d.page &&
			(d.page = o.extend({
				...
				jump: function(e, a) {
					if (a || (n.page = e.curr, d.limit = e.limit, n.pullData(e.curr)), n.config.pageLanguage && n.config.pageLanguage !==
						!0) {
						var t;
						if ("string" == typeof n.config.pageLanguage) {
							if (!u.config.pageLanguageText[n.config.pageLanguage]) return void console.log("找不到" + n.config.pageLanguage +
								"对应的语言文本定义");
			...
			}, d.page), d.page.count = t, c.render(d.page)), void W.call(n, !0))))
	};
	...
	u.Class.prototype.setColsWidth = function() {
		...
		if (e.elem[i.length && e.layHeader.first().find(".layui-table").width() - 1 > e.layHeader.first().width() ?
			...
			}), c && e.layFixed.find(">" + _ + ' th[rowspan="' + l + '"]').height("auto")
		}
		...
		var l;
		t.colFilterRecord ? l = ie.get(i, t.colFilterRecord) : ie.clear(i);
		var n = function(e, i, o, r) {
			if (!r) return void i.splice(o, 1);
			if (r.key = e + "-" + o, r.hide = r.hide || !1, r.colspan = r.colspan || 1, r.rowspan = r.rowspan || 1, a.initOpts(
					r), r.hide = l && "normal" === r.type && r.field && "boolean" == typeof l[r.field] ? l[r.field] : r.hide, r.field ||
				...
				layui.each(t.cols[s], function(a, i) {
					i.HAS_PARENT || c >= 1 && c == (r.colspan || 1) || (i.HAS_PARENT = !0, i.parentKey = e + "-" + o, c +=
						parseInt(i.colspan > 1 ? i.colspan : 1), n(s, t.cols[s], a, i))
				}), r.colGroup = !0
			}
		};
	...
	u.Class.prototype.reload = function(e) {
		...
		var l = this,
			...
			s = l.config,
			d = a || {};
		e = -e, l.layBody.find('tr[data-index="' + e + '"]').length || (u.cache[l.key][e] = d, l.eachCols(function(a, t) {
				var i = t.field || a,
					l = s.index + "-" + t.key,
					u = d[i];
				if (void 0 !== u && null !== u || (u = ""), !t.colGroup) {
					var f = ['<td data-field="' + i + '" data-key="' + l + '" ' + function() {
						var e = [];
						return "normal" === t.type && t.edit !== !1 && e.push('data-edit="text"'), t.align && e.push('align="' + t
								.align + '"'), t.templet && e.push('data-content="' + u + '"'), t.toolbar && e.push('data-off="true"'),
							t.event && e.push('lay-event="' + t.event + '"'), t.style && e.push('style="' + t.style + '"'), t.minWidth &&
					...
					c.push(f), t.fixed && "right" !== t.fixed && n.push(f), "right" === t.fixed && r.push(f)
				}
			}), l.layMain.find("." + D).remove(), l.elem.removeClass("layui-table-none-overflow"), l.layMain.find("tbody").append(
				'<tr class="layui-tablePlug-data-temp" data-index="' + e + '">' + c.join("") + "</tr>"), l.layFixLeft.removeClass(
				P).find("tbody").append('<tr class="layui-tablePlug-data-temp" data-index="' + e + '">' + n.join("") + "</tr>"),
			l.layFixRight.find("tbody").append('<tr class="layui-tablePlug-data-temp" data-index="' + e + '">' + r.join("") +
				"</tr>"), l.renderForm(), l.resize(), i || l.layBody.scrollTop(l.layBody[0].scrollHeight), l.layBody.find(
				'tr.layui-tablePlug-data-temp[data-index="' + e + '"]').find("td:first-child").append(
				'<div class="close_temp"></div>'), l.layFixRight.find(".close_temp").remove(), "function" == typeof t && t.call(
				l.config, l.layBody.find('tr[data-index="' + e + '"]')))
		...
		var t = I(e),
			...
			l = u.cache[e] || [];
		if (i.data.length)
			for (var n = i.numbers, r = 1; r < n && (!l[-r] || a && -r !== a || (l[-r] = [], !a)); r++);
	...
	var q = function(e, a, t, i) {
		if (i.colGroup) {
			var l = 0;
			e++, i.CHILD_COLS = [];
			var n = t + (parseInt(i.rowspan) || 1);
			layui.each(a[n], function(t, o) {
				o.PARENT_COL_INDEX || l >= 1 && l == (i.colspan || 1) || (o.PARENT_COL_INDEX = e, i.CHILD_COLS.push(o), l +=
					parseInt(o.colspan > 1 ? o.colspan : 1), q(e, a, n, o))
			})
		}
	};
	u.eachCols = function(e, a, t) {
		var i = this,
			l = i.thisTable.config[e] || {},
			n = l.cols ? i.thisTable.arrs[e] || [] : [],
			r = 0;
		t = o.extend(!0, [], t || l.cols);
		var c;
		n.length ? (console.log("命中缓存!!"), c = !0) : layui.each(t, function(a, l) {
			return a > 0 || void layui.each(l, function(l, o) {
				q(r, t, a, o), o.PARENT_COL_INDEX || (n.push(o), i.thisTable.arrs[e] = n)
			})
		});
		var s = function(e) {
			layui.each(e || n, function(e, i) {
				var l = i.key.split("-");
				return c && (i.hide = t[l[0]][l[1]].hide, i[u.config.checkName] = !1, i.width = i.width || 0), i.CHILD_COLS ?
	...
	var X = function() {
		...
		u.eachCols(t, function(t, l) {
			if ("normal" === l.type) {
				...
				l.filter ? r.find(".layui-table-filter").length ? r.find(".layui-table-filter").removeClass("layui-active") :
					o(E.join("")).insertAfter(r.find(".layui-table-cell>span:not(.layui-inline)")).click(function(t) {
						...
						l.length && l[0] !== this && (l.removeClass("layui-active"), e.layBody.find("tr." + P).removeClass(P));
						...
						m + d > o(document).width() && (m -= d + y.width()), h = s.open({
							...
							success: function(a, t) {
								a.find(".layui-layer-content").html(
									...
									data: c.map(function(a, t, i) {
										...
										return l[u.config.checkName] = !e.layBody.find("tr." + P).filter(function(e, t) {
							...
							"all" === a.type ? e.layBody.find("tr")[a.checked ? "removeClass" : "addClass"](P) : layui.each(e.layBody
								.first().find('tr td[data-field="' + n + '"]'),
								function(t, i) {
									if (i = o(i), i.text() === a.data.name) {
										var l = i.parent();
										e.layBody.find('tr[data-index="' + l.data("index") + '"]')[a.checked ? "removeClass" : "addClass"](P)
									}
								})
						})
	...
	u.reload = function(e, a, t) {
		...
		var l = Z(e),
			n = o.extend(!0, {}, Z(e), a);
		if (n.checkStatus || F.reset(e), Q.enable() && n.smartReloadModel) {
			var r = !1;
	...
	u.checkStatus = function(e, a) {
		var t = this,
			i = ee.call(t, e),
			l = Z(e);
		if (l && l.checkStatus && (i.status = F.get(e), a)) {
			i.dataCache = [];
			var n = K[l.id];
			layui.each(i.status[v].concat(i.status[x]), function(e, a) {
				n[a] && i.dataCache.push(u.clearCacheKey(n[a]))
			})
		}
		if (l && l.checkDisabled) {
			var o = l.checkDisabled;
			if ("object" == typeof o && o.enabled !== !1) {
				var r = 0,
					c = 0,
					s = te(l),
					d = F.get(e, k);
				layui.each(u.cache[e], function(e, a) {
					var t = a[s];
					d.indexOf(t) === -1 && (r++, a[u.config.checkName] && c++)
				}), i.isAll = c > 0 && r === c
			}
		}
		return i
	...
	o(document).on("change", 'input[lay-filter="LAY_TABLE_TOOL_COLS"]', function(e) {
		var a = o(this),
			...
			n = Z(l),
			r = n.colFilterRecord;
		r ? ie.set(l, t, this.checked, r) : ie.clear(l)
		...
		switch (e.event) {
			case "LAYTABLE_COLS":
				var i = t.find(".layui-table-tool-panel"),
					l = i.find('[lay-filter="LAY_TABLE_TOOL_COLS"]'),
	...
	le(!0), d.on("checkbox(layTableAllChoose)", function(e) {
		var a = o(e.elem),
			t = a.closest("." + L);
	...
	var ne = function(e, a) {
			var t = this,
				i = {},
				l = t.config,
				n = t.layMain.scrollTop(),
				o = t.layMain.scrollLeft();
			return e = e >= 0 ? e : t.layBody.find("tr." + N).data("index"), i[l.response.statusName] = l.response.statusCode,
				i[l.response.msgName] = "数据更新", i[l.response.dataName] = u.cache[l.id], i[l.response.countName] = t.count || (l.page ?
					l.page.count : l.data.length), a && t.layHeader.find(".layui-table-sort[lay-sort]").attr("lay-sort", ""), t.renderData(
					i, t.page, i[l.response.countName], a), t.layBody.scrollTop(n), t.layMain.scrollLeft(o), "function" == typeof l.done &&
				l.done(i, t.page, i[l.response.countName]), e >= 0 && setTimeout(function() {
		...
		oe = function(e, a, t) {
			...
			if (l) {
				...
				n.splice(t, 0, n.splice(a, 1)[0]), ne.call(l, t, !0)
			}
			return i
		},
		re = function(e, a, t) {
			...
			if (l) {
				var n = u.cache[e],
					r = l.config;
				if (!t) return ne.call(l), i;
				R(t) && (a = ""), "" !== a ? o.extend(!0, n[a], t) : (R(t) || (t = [t]), r.primaryKey ? layui.each(t, function(e,
					a) {
					a[r.primaryKey] && layui.each(n, function(e, t) {
						if (t[r.primaryKey] === a[r.primaryKey]) return o.extend(!0, n[e], a), !0
					})
				}) : o.extend(!0, n, t)), ne.call(l)
			}
			return i
		},
		ce = function(e, a) {
			...
			if (i) {
				...
				if (R(l.data)) {
					...
					var n = te(l);
					layui.each(a, function(e, a) {
						n && (a[n] || (a[n] = "idTemp_" + (new Date).getTime() + "_" + Math.round(1e6 * Math.random()))), l.data.push(
							a)
					}), u.reload(e)
				}
				return t
		...
		se = function(e, a) {
			...
			if (i) {
				var l = i.config,
					n = {},
					o = i.count || (l.page ? l.page.count : l.data.length),
					r = te(l);
				if (l.url) {
					if (l.page) {
						o -= R(a) ? a.length : 1, n.page = {};
				...
				if (R(l.data)) {
					if ("object" == typeof a || R(a)) R(a) || (a = [a]), layui.each(a, function(a, t) {
						...
						if (isNaN(a)) return t;
						var s;
						if (l.page ? a < l.page.limit && (s = l.data.splice((i.page - 1) * l.page.limit + a, 1)) : s = l.data.splice(a,
								1), !s.length) return t;
		...
		de = function(e, a) {
			...
			return a === !1 ? (de.clear(e), t) : a || 0 === a ? ((a === !0 || a < 50) && (a = 50), de.clear(e), void(i[e] = {
				...
				index: setInterval(function() {
					o(document).find(n.elem).length ? de(e) : de.call(t, e, !1)
				}, a)
	...
	var ue = function(e, a, t) {
		...
		if (!e) return console.warn("tableId不能为空"), i;
		var l;
		if ("string" == typeof e ? l = I(e) : (l = e, e = l.key || (l.config ? l.config.id : "")), !l || !e) return console
			.warn("找不到id为", e, "的实例"), i;
		var n = l.config;
		...
		return a ? (r.find('td[data-field="' + a + '"] div.layui-table-cell').html(t || ""), i) : void u.eachCols(e,
			function(a, t) {
				if (t.totalRow && !t.totalRowText && t.field) {
					...
					if ("function" == typeof c) i = c.call(n, e, s, l);
					else switch (i = 0, c) {
						case "sum":
